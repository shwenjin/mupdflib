...
/**
 * Created by wenjin on 2017/11/12.
 */
...
public class SpringProgressView extends View {
    ...
    /**分段颜色*/
    private static final int[] SECTION_COLORS = {Color.rgb(184, 184, 184),Color.rgb(184, 184, 184),Color.rgb(184, 184, 184)};
    /**进度条最大值*/
...
//		mPaint.setColor(Color.rgb(0,163,175));
        mPaint.setColor(Color.rgb(229, 229, 229));
...
//				mPaint.setColor(Color.rgb(124,213,223));
            }
        }else{
